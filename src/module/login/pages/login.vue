<template>
  <div id="login">
    ...
    <el-form :model="loginInfo" :rules="rules" ref="loginInfo" label-position="left" label-width="0px"
             class="login-container" v-loading="loading" element-loading-text="正在玩命登录...">
      <el-form-item prop="accountName">
        <el-input v-model="loginInfo.accountName" type="text" auto-complete="off" placeholder="用户名"></el-input>
        <!--v-model传值-->
      </el-form-item>
      ...
      <el-form-item style="width:100%;">
        <el-button type="primary" id="loginBtn" style="margin-top: 15px" class="nextButton" @click="login('loginInfo')">
          登录
        </el-button>
      </el-form-item>
    </el-form>
