  ...
  <div id="register">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px"
      ...
      <el-form-item prop="userName">
        <el-input v-model="ruleForm.userName" type="text" auto-complete="off" placeholder="用户名，英文+数字不超过20位"></el-input>
        <!--v-model传值-->
      </el-form-item>
      ...
      <el-form-item prop="code">
        <el-row>
          ...
          <el-col :span="8">
            <el-button type="primary" class="nextButton codeButton">获取验证码</el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item>
    ...
    <el-row style="text-align: center">
      <span class="registerStep highlight">1 设置用户名 </span><span class="registerStep">2 完善个人信息 </span><span
