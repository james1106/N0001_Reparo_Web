        ...
        <div>
          <el-row class="dataTable">
            <el-row class="el-row-header">
              <el-col :span="6" style="margin-left: 19px;">仓储业务编号：{{item.orderNo}}</el-col>
            ...
            <el-row class="el-row-content">
              ...
              <el-col :span="3">
                <el-button type="text" @click.native.prevent="checkDetail('1')">查看详情</el-button>
              </el-col>
            </el-row>
          </el-row>
        </div>
